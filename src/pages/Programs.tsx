    ...
    return(
      ...
      <IonContent>
        ...
        >
          ...
          {
            sundayData.length < 1 && (
              <h1 className='text-center text-white font-extrabold mt-10 text-2xl'>Loading.....</h1>
            )
          }
          {
            sundayData.length > 0 && (
                <div className='p-2 max-w-[500px] m-auto text-white'>
          <h2 className='bg-[#8b9adc] p-2'>Monday</h2>

          <div className='p-2 font-bold'>
            {mondayData.map((item:any) => (
                <div className='flex gap-2 items-center mb-2 text-xs'>           
                  <h1>{item.time}</h1>
                  <h1 style={{borderLeft: '5px solid'}} className='text-green-100 rounded line-clamp-2 flex-1 px-1'>{item.program}</h1>
                  <h1  className='text-green-100 rounded line-clamp-2 flex-1 px-1'>{item.social}</h1>
                </div>
                ))}
          </div>

          <h2 className='bg-[#8b9adc] p-2'>Tuesday</h2>

          <div className='p-2 font-bold'>
            {tuesdayData.map((item:any) => (
                <div className='flex gap-2 py-2 items-center mb-2 text-xs'>           
                  <h1>{item.time}</h1>
                  <h1 style={{borderLeft: '5px solid'}} className='text-green-100 rounded line-clamp-2 flex-1 px-1'>{item.program}</h1>
                  <h1  className='text-green-100 rounded line-clamp-2 flex-1 px-1'>{item.social}</h1>
          ...
          <h2 className='bg-[#8b9adc] p-2'>Wednesday</h2>
          ...
          <h2 className='bg-[#8b9adc] p-2'>Thursday</h2>
          ...
          <h2 className='bg-[#8b9adc] p-2'>Friday</h2>
          ...
          <h2 className='bg-[#8b9adc] p-2'>Saturday</h2>
          ...
          <h2 className='bg-[#8b9adc] p-2'>Sunday</h2>
