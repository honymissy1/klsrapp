        ...
        <div style={{minHeight:'100vh', margin:'0px auto', backgroundSize: 'cover', backgroundImage: "url('/images/background.jpg')", backgroundRepeat: 'no-repeat'}}>
          <div style={{width: '100%', height: 'max-content'}}>
            <div className='relative overflow-hidden w-full h-[30vh] bg-[#002F3D]'>
               <div className='z-10 absolute w-full h-full bg-[#0b152ba7]'></div>
               ...
               <h1 className='text-3xl py-1 font-extrabold'>KLSR</h1>
                <p className='font-bold italic'>Reaching the world with 24/7 edifying contents</p>
               </div>
            </div>
          </div>
                ...
                <a href="https://www.kingdomlifestyleradio.com">
                  ...
                  <IonCardHeader>
                    ...
                    <IonCardContent style={{textAlign: 'center'}}>
                      <p>For more edifying and life transforming contents visit our website now <span className='text-green-500'>www.kingdomlifestyleradio</span></p>
                    </IonCardContent>
                  </IonCard>
